	...
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			// Catalog
				...
				if ($this->user->hasPermission('access', 'procurement/products')) {
					$procurement[] = array(
						'name'	   => $this->language->get('text_procurement_products'),
						'href'     => $this->url->link('procurement/products', 'token=' . $this->session->data['token'], true),
						'children' => array()		
					);
				}
				...
				if ($procurement) {
					$data['menus'][] = array(
						...
						'name'	   => $this->language->get('text_procurement'),
						'href'     => '',
			...
			*/	
			...
			if ($this->user->hasPermission('access', 'marketing/bonus_account')) {
				$marketing[] = array(
					'name'	   => $this->language->get('text_bonus_account'),
					'href'     => $this->url->link('marketing/bonus_account', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
