                ...
                <table class="form minification" style="margin-top:-10px;">
                  ...
                  <tr>
                    ...
                    <select class="form-control" name="Nitro[Mini][MergeCSSMedia]">
                        <option value="no" <?php echo (empty($data['Nitro']['Mini']['MergeCSSMedia']) || $data['Nitro']['Mini']['MergeCSSMedia'] == 'no') ? 'selected=selected' : ''?>>No</option>
                        <option value="yes" <?php echo( (!empty($data['Nitro']['Mini']['MergeCSSMedia']) && $data['Nitro']['Mini']['MergeCSSMedia'] == 'yes')) ? 'selected=selected' : ''?>>Yes</option>
                    </select>
                    </td>
                  </tr>
                  <tr>
                ...
                <table class="form minification" style="margin-top:-10px;">
                  ...
                  <tr>
                    ...
                    <select class="form-control" name="Nitro[Mini][inlineJSCombine]">
                        <option value="no" <?php echo (empty($data['Nitro']['Mini']['inlineJSCombine']) || $data['Nitro']['Mini']['inlineJSCombine'] == 'no') ? 'selected=selected' : ''?>>No (Recommended)</option>
                        <option value="yes" <?php echo( (!empty($data['Nitro']['Mini']['inlineJSCombine']) && $data['Nitro']['Mini']['inlineJSCombine'] == 'yes')) ? 'selected=selected' : ''?>>Yes</option>
                    </select>
                    </td>
                  </tr>
                  <tr>
