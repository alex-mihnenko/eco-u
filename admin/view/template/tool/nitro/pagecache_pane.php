    ...
    <table class="form pagecache">
      ...
      <tr>
        ...
        <select class="form-control" name="Nitro[PageCache][MergeDeviceCache]">
            <option value="no" <?php echo (empty($data['Nitro']['PageCache']['MergeDeviceCache']) || $data['Nitro']['PageCache']['MergeDeviceCache'] == 'no') ? 'selected=selected' : ''?>>Disabled</option>
            <option value="yes" <?php echo( (!empty($data['Nitro']['PageCache']['MergeDeviceCache']) && $data['Nitro']['PageCache']['MergeDeviceCache'] == 'yes')) ? 'selected=selected' : ''?>>Enabled</option>
        </select>
        </td>
      </tr>
      <tr>
