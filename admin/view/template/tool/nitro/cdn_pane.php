  ...
  <div class="box-content">
    <table class="form cdnpanetable">
      ...
      <tr>
        ...
        <td>
    		<textarea class="form-control" name="Nitro[CDNStandard][IgnoredRoutes]" style="width:400px; height:180px;" placeholder="One route per line, e.g. information/sitemap"><?php echo (!empty($data['Nitro']['CDNStandard']['IgnoredRoutes'])) ? $data['Nitro']['CDNStandard']['IgnoredRoutes'] : '' ?></textarea>
        </td>
      </tr>
    </table>
  </div>
