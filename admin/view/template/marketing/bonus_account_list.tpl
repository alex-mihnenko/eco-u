          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'm.code') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php echo $column_coin; ?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($setting['bonus_account_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $setting['bonus_account_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $setting['bonus_account_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $setting['name']; ?></td>
                  <td class="text-left"><?php echo $setting['code']; ?></td>
                  <td class="text-left"><?php echo $setting['coin']; ?></td>
                  <td class="text-right"><?php echo $setting['status']; ?></td>
                  <td class="text-right"><a href="<?php echo $setting['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
