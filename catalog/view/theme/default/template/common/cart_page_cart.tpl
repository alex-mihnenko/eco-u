<div class="m-basket_border">
        ...
        <div class="m-basket_title-message">Скидка <?php echo $discount; ?> рублей. <a href="#"data-remodal-target="modal-coupon">Введите купон</a><?php if(!$islogged) { ?> или <a href="#" id="btn-cart-auth">авторизируйтесь</a><?php } ?>, чтобы получить дополнительную скидку</div>
        <?php if($error_total) { ?>
