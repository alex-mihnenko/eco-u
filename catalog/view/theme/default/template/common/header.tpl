...
<?php } ?>
	...
	<div class="wreaper" id="body">
		...
		<div class="remodal modal-bonus-program" data-remodal-id="modal-bonus-program">
			...
			<div class="body">
				<h2 class="h3">Бонусная система</h2>
				<hr class="indent xs">

				<p class="xs text-align-left">
					Мы разработали бонусную систему, которая позволит вам получить накопительную скидку уже с первой покупки. 
					<br><br>
					Теперь за каждые 20 рублей совершенного заказа на Ваш бонусный счет будет начислен 1 экоин. При следующем заказе вы сможете использовать его при оформлении заказа и получить скидку на эквивалент накопленных бонусов в рублях. 
					<br>
				...
				<h2 class="h3">Как еще получить бонусы?</h2>
				<hr class="indent xs">
				...
				<div class="text-align-left">
                    ...
                    <ul class="list">
                        <li>повторный заказ в течении недели + 300 екоинов</li>
                        <li>повторный заказ в течении двух недель + 150 екоинов</li>
                    </ul>
                    <hr class="indent xs">

                    <p class="xs"><b>За обратную связь:</b></p>
                    <ul class="list">
                        <li>За оставленный отзыв на сайте + 100 екоинов</li>
		...
		<div class="remodal modal-vegan-card-info" data-remodal-id="modal-vegan-card-info">
			<button data-remodal-action="close" class="remodal-close"></button>

			<div class="body">
				<h2 class="h3">Где получить Vegetarian Card?</h2>
				<hr class="indent md">
				...
				<p>
					...
					Равным образом начало повседневной работы по формированию позиции представляет собой интересный эксперимент проверки существенных финансовых и административных условий. Разнообразный и богатый опыт сложившаяся структура организации позволяет оценить значение соответствующий условий активизации.
				</p>
			</div>
		</div>
