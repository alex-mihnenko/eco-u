<?php
// Heading
$_['heading_title']      = 'Vegetarian Card';
$_['sub_title']      	 = 'Это единственная в мире скидочная система, созданная специально для людей, которые ведут осознанный и здоровый образ жизни. В нашем магазине владельцы данной карты могут получить дополнительные бонусы за покупки на свой счет.';
