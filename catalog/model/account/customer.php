...
class ModelAccountCustomer extends Model {
	...
	public function editCustomer($data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', custom_field = '" . $this->db->escape(isset($data['custom_field']) ? json_encode($data['custom_field']) : '') . "', vegan_card = '" . $this->db->escape(isset($data['vegan_card']) ? json_encode($data['vegan_card']) : '') . "' WHERE customer_id = '" . (int)$customer_id . "'");
	}
