...
Class ModelYamodelYamarket extends Model
{
	...
	public function getProducts($allowed_categories, $vendor_required = true) {
		$query = $this->db->query("SELECT p.*, pd.name, pd.description_yml, m.name AS manufacturer, p2c.category_id, p.price AS price, ps.price AS special, wcd.unit AS weight_unit,
