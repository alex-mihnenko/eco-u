<?php
class ControllerAccountVegancard extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$this->load->language('account/vegan_card');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('account/vegan_card', '', true)
		);
        ...
        $this->response->setOutput($this->load->view('account/vegan_card', $data));
	}
