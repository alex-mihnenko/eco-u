              				...
              				foreach ($childs as $key_child => $child) {
	              				// ---
	              					$childs_html .= '
	              						<div class="child">
				              				<div class="author">
				              					<div class="image" style=" background: url('.$child['image'].') no-repeat center center scroll; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;"></div>
				              				</div>
				              				<div class="body">
					              				<div class="about">
