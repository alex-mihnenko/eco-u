...
class ControllerAjaxIndex extends Controller {
  ...
  // Получить продукты для слайдера спеццена
  public function ajaxGetProductsSpecialPrice() {
      $this->load->model('catalog/product');
      
      $products = $this->model_catalog_product->getProductsSpecialPrice();
      $tpl = '';
                        ...
                        <div class="p-o_block">
                                ...
                                <div class="clearfix">
                                        ...
                                        <div class="p-o_right">
                                                ...
                                                <meta itemprop="price" content="'.(int)$product['special_price'].'">
                                                <div class="p-o_price">'.(int)$product['special_price'].' <span>руб</span></div>
